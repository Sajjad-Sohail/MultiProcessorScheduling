...
//}
//
//linked_list::linked_list(linked_list *ob)
//{
//	head = ob->head;
//	tail = ob->tail;
//}
//
//void linked_list::add_node(pcb *p, int cpu_no, int work_done)
//{
...
//	}
//}
////int linked_list::edit_node(pcb *p, int cpu_no, int work_done, linked_list *ll)
////{
////	Partition *tmp = new Partition;
...
////	return flag;
//////}
////int linked_list::getCPU(pcb *p)
////{
////	pcb ptpcb = new pcb(p);
////	return ptpcb.getCPU();
//////}
////void linked_list::display(linked_list *ll, ostream &outfile)
////{
////	Partition *tmp;
////	linked_list *t = new linked_list(ll);
////	tmp = t->head;
...
////	}
//////}
////void linked_list::add_dummy(int cpu)
////{
////	Partition *tmp = new Partition;
////	//kaushik
////	//tmp->pb= p;
...
////	}
////}
////void linked_list::check_node(linked_list *ll, deque<pcb> &stats_q, int clock)
////{
////	Partition *tmp;
////	linked_list *t = new linked_list(ll);
////	tmp = t->head;
...
////	}
////}
////void linked_list::clear_node(linked_list *ll)
////{
////
////	Partition *tmp;
////	linked_list *t = new linked_list(ll);
...
////	}
////}
//void linked_list::insert_position(int pos, pcb *p, int cpu_no, int work_done)
//{
...
//}
//
//Partition* linked_list::deleteMid(Partition *head)
//{
//	// Base cases
//	if (head == NULL)
//		return NULL;
